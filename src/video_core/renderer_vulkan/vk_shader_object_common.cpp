...
#include "video_core/renderer_vulkan/vk_shader_object_common.h"
#include "video_core/renderer_vulkan/vk_scheduler.h"

namespace Vulkan {

ShaderObject::ShaderObject(const Instance& instance_, Scheduler& scheduler_, DescriptorHeap& desc_heap_,
...
void ShaderObject::BindResources(DescriptorWrites& set_writes, const BufferBarriers& buffer_barriers,
...
std::string ShaderObject::GetDebugString() const {
