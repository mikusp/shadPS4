...
public:
    ...
    ComputeShaderObject(const Instance& instance, Scheduler& scheduler, DescriptorHeap& desc_heap,
                    const Shader::Profile& profile, vk::PipelineCache pipeline_cache,
                    ComputePipelineKey compute_key, const Shader::Info& info,
                    vk::ShaderEXT shader, SerializationSupport& sdata, bool preloading);
    ~ComputeShaderObject();
