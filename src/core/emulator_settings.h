...
struct VulkanSettings {
    ...
    Setting<bool> shader_objects_enabled{false};
    std::vector<OverrideItem> GetOverrideableFields() const {
        return std::vector<OverrideItem>{
            ...
            make_override<VulkanSettings>("shader_objects_enabled",
                                          &VulkanSettings::shader_objects_enabled),
        };
    }
};
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(VulkanSettings, gpu_id, renderdoc_enabled, vkvalidation_enabled,
                                   ...
                                   pipeline_cache_archived, shader_objects_enabled)
...
#define SETTING_FORWARD_BOOL_READONLY(group, Name, field)                                          \
    ...
    SETTING_FORWARD_BOOL(m_vulkan, ShaderObjectsEnabled, shader_objects_enabled)
